...
+ (UIColor *)blendColor:(UIColor *)color1
    ...
    CGFloat beta = 1.0 - percentage;
    CGFloat r1, g1, b1, a1, r2, g2, b2, a2;
    [color1 getRed:&r1 green:&g1 blue:&b1 alpha:&a1];
    [color2 getRed:&r2 green:&g2 blue:&b2 alpha:&a2];
    CGFloat red     = r1 * beta + r2 * percentage;
    CGFloat green   = g1 * beta + g2 * percentage;
    CGFloat blue    = b1 * beta + b2 * percentage;
    CGFloat alpha   = a1 * beta + a2 * percentage;
